                                ...
                                {editingDocIdx === idx ? (
                                  <div className="mt-2 flex items-center gap-2">
                                    <input
                                      ...
                                      className="bg-white border border-slate-200 rounded-lg px-2 py-1 text-[10px] font-semibold text-slate-900 focus:outline-none focus:ring-1 focus:ring-[#D99A1C] max-w-[200px]"
                                  ...
                                  <div className="mt-1 flex flex-wrap items-center gap-2">
                                    ...
                                    >
                                      {doc.comment ? 'Edit Comment' : '+ Add Comment'}
                                    </button>
                                  </div>
                                )}
