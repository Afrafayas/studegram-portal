...
export default function Sidebar({ activePage, setActivePage, onLogout, isOpen, onClose }) {
  const mainItems = [
    ...
    { id: 'ListOfUniversities', label: 'List of Universities', icon: 'M4 6h16M4 10h16M4 14h16M4 18h16' },
  ];
  ...
  return (
    <>
      ...
      <div className={`fixed inset-y-0 left-0 z-50 md:z-30 md:static w-[240px] min-w-[240px] bg-[#0A0A0F] h-screen md:h-auto md:min-h-[calc(100vh-60px)] flex flex-col justify-between py-4 select-none text-white transform ${
        ...
        <div className="px-4 py-3 mx-2 mt-auto border-t border-white/5 flex items-center justify-between bg-white/5 rounded-xl">
