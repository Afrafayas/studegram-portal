        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredUniversities.map((uni) => (
            ...
            >
              ...
              <div className={`h-24 bg-gradient-to-r ${uni.gradient} p-4 flex flex-col justify-between relative`}>
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1 bg-white/25 backdrop-blur-md text-white px-2 py-0.5 rounded-lg text-xs font-bold">
